...
class _StartScreenState extends State<StartScreen>
  ...
  CurvedAnimation _introInterval(double begin, double end,
  ...
  void initState() {
    ...
    _blinkController =
        AnimationController(vsync: this, duration: _kBlinkDuration)
          ..repeat(reverse: true);

    _introController =
        AnimationController(vsync: this, duration: _kIntroDuration);

    _idleController =
        AnimationController(vsync: this, duration: _kIdleDuration);
    ...
    _titleOpacity = _introInterval(1, 1);
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: FadeTransition(
                              opacity: Tween<double>(begin: 0.6, end: 1.0).animate(_blinkOpacity),                            
                              ...
                              child: ScaleTransition(
                                ...
                                child: Transform.scale(
                                  scale: 1.1,
                                  child:
                                      Image.asset('assets/misc/kow.png'),
                                ),
                              ),
                            ),
                          ),
                          ...
                          child: FadeTransition(
                            ...
                            child: Text(
                              ...
                              style: TextStyle(
                                ...
                                // spacing
                                letterSpacing: 2.0,   // ← adjust (1.5–3.0 sweet spot)
