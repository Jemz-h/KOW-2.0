...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  Future<void> _showAudioSettings(BuildContext context) async {
    ...
    bool musicOn = audio.musicEnabled;
    bool sfxOn = audio.sfxEnabled;
    double musicVolume = audio.musicVolume;
    double sfxVolume = audio.sfxVolume;
                                ...
                                Column(
                                  children: [
                                    ...
                                    GestureDetector(
                                      onTap: () async {
                                        final next = !musicOn;
                                        setState(() => musicOn = next);
                                        await audio.setMusicEnabled(next);
                                      },
                                      child: Container(
                                  ...
                                  children: [
                                    ...
                                    GestureDetector(
                                      onTap: () async {
                                        final next = !sfxOn;
                                        setState(() => sfxOn = next);
                                        await audio.setSfxEnabled(next);
                                      },
                                      child: Container(
                                        width: iconButtonSize,
                                        height: iconButtonSize,
                          ...
                          Center(
                            child: _buildMenuButton(
                              ...
                              gradient: const RadialGradient(
                                ...
                                radius: 1.2,
                                colors: [Color(0xFFFFFFFF), Color(0xFF3C467B)],
                              ),
                              label: 'PROFILE',
                          ...
                          Center(
                            child: _buildMenuButton(
                              ...
                              gradient: const RadialGradient(
                                center: Alignment.centerLeft,
                                radius: 1.2,
                                colors: [Color(0xFFFFFFFF), Color(0xFFFF9D00)],
                              ),
                              label: 'ACHIEVEMENTS',
                              iconAsset: 'assets/icons/gold.svg',
                              onTap: () => showAchievementDialog(context),
                            ),
                          ),
                          Center(
                            child: _buildMenuButton(
                              ...
                              gradient: const RadialGradient(
                                center: Alignment.centerLeft,
                                radius: 1.2,
                                colors: [Color(0xFFFFFFFF), Color(0xFF571272)],
                              ),
                              label: 'AUDIO',
                              iconAsset: 'assets/icons/unmute.svg',
                          ...
                          Center(
                            child: _buildMenuButton(
                              ...
                              gradient: const RadialGradient(
                                center: Alignment.centerLeft,
                                radius: 1.2,
                                colors: [Color(0xFFFFFFFF), Color(0xFFCA22A6)],
                              ),
                              label: 'THEMES',
                              iconAsset: 'assets/icons/brush.svg',
...
class _PillThumbShape extends SliderComponentShape {
  ...
  void paint(
    ...
    canvas.drawLine(
      Offset(center.dx - 4, center.dy - 9),
      Offset(center.dx - 4, center.dy + 9),
      lp,
    );
    canvas.drawLine(
